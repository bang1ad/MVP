...
<head>
    ...
    <link rel="stylesheet" href="{{asset('frontend/css/custom-jquery-modal.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/bootstrap-modal.css')}}" />
    <link href='https://api.mapbox.com/mapbox-gl-js/v2.14.1/mapbox-gl.css' rel='stylesheet' />
    <link href='//cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css' rel='stylesheet' />
    <link rel="stylesheet" href="{{asset('frontend/css/old.css')}} " />
    <link rel="stylesheet" href="{{asset('frontend/css/common.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/index.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/responsiv.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/issues.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/issues2.css')}}" />
    <link rel="stylesheet" href="{{asset('frontend/css/issues3.css')}}" />
